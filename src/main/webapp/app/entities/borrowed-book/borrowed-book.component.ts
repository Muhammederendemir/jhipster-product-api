...
export class BorrowedBookComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.borrowedBookService
            ...
            .subscribe(
                (res: HttpResponse<IBorrowedBook[]>) => this.paginateBorrowedBooks(res.body, res.headers),
    ...
    registerChangeInBorrowedBooks() {
        this.eventSubscriber = this.eventManager.subscribe('borrowedBookListModification', response => this.loadAll());
    }
